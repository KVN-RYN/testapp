...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: yRxH7M8asot/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: s9y3zGrscW2/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: yowy2HMIL39/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__nsAx1)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__qA1Tr)}
                role={"img"}
              />
            ),
